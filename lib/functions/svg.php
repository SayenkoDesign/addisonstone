...
function get_svg( $type = '' ) {
	...
	$svgs = array(  
        ...
        'menu-icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="38" height="34" class="menu-icon" viewBox="0 0 38 34"><g fill="none" fill-rule="evenodd" stroke="#335D94" stroke-width="3" stroke-linecap="square"><path d="M2 22h34M2 12h34M2 32h27M2 2h27"/></g><span class="screen-reader-text">menu icon</span></svg>',
